...
import DopCartProduct from "./DopCartProduct"

import { clearCart, removeItemCart, plusItemCart, minusItemCart } from '../redux/actions/cart';

import cartEmtryImage from '../assets/img/empty-cart.png'
							...
							itemsCount ? (
								<>
									<div className="cart__top">
										...
										<div className="cart__clear">
											...
											<span className="clear__cart" onClick={onClearCart}>Очистить корзину</span>
										</div>
									</div>
									<h3 className="cart__count">{itemsCount} {itemsCount <= 4 ? "товара" : "товаров"}</h3>
									<div className="content__items">
										{
											allProduct.map((obj) => {
												return <CartProduct id={obj.id}
													name={obj.name}
													img={obj.imageUrl}
									...
									<div className="cart__bottom">
										<div className="cart__bottom-details">
											...
											<span> Сумма заказа: <b className="final-price">{totalPrice} ₽</b> </span>
										</div>
										<div className="cart__bottom-buttons">
											<a href="/" className="button button--outline button--add go-back-btn none">
											...
											<Link to="cart/orders" className="button pay-btn">
								...
								<>
									<div className="cart cart--empty">
										...
										<img src={cartEmtryImage} alt="Empty cart" />
